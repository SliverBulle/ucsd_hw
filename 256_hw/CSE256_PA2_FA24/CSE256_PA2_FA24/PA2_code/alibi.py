...
from adapted_transformer import TransformerEncoder, AliBi, TransformerDecoder, FeedforwardClassifier
...
epochs_CLS = 30  # epochs for classifier training
...
def main():
    ...
    plt.plot(train_accuracies, label='alibi')
    plt.xlabel('Epochs')
    plt.ylabel('Training Accuracy')
    plt.title('Training Accuracy for alibi')
    plt.legend()
    plt.grid()
    ...
    training_accuracy_file = f'plot/alibi_train_accuracy_{current_time}.png'
